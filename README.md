# com-chilipeppr-workspace-drgrbl
A ChiliPeppr Workspace dr grbl.



## ChiliPeppr Workspace / drgrbl
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-drgrbl |
| Name                  | Workspace / drgrbl |
| Description           | A ChiliPeppr Workspace dr grbl. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/dagrende/workspace-drgrbl/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/dagrende/drgrbl |
| Github URL            | http://github.com/dagrende/workspace-drgrbl |
| Test URL              | https://preview.c9users.io/dagrende/drgrbl/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/dagrende/workspace-drgrbl/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-drgrbl"], // the id you gave your workspace
      function(myWorkspaceDrgrbl) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / drgrbl just got loaded.", myWorkspaceDrgrbl);
        myWorkspaceDrgrbl.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-drgrbl"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / drgrbl"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace dr grbl."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/dagrende/workspace-drgrbl/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/dagrende/drgrbl"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/dagrende/workspace-drgrbl"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://drgrbl-dagrende.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
